    ...
    on_run(function ()
        ...
        for _, slang in ipairs(slangs) do
            ...
            if is_host("windows") then
                ...
                local dxilProfiles = { triangle_mesh = "sm_6_5", rt_triangle = "lib_6_3", rt_gltf = "lib_6_5", rt_gltf_rayquery = "cs_6_5", rt_pathtrace = "cs_6_5", mesh_frag = "sm_6_0", rayquery = "cs_6_5", rt_rayquery = "cs_6_5", barycentric = "sm_6_1", wave = "cs_6_0" }
