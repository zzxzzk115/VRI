target("example-pbrbasic")
    ...
    if is_plat("wasm") then
        -- Web build: ASYNCIFY for WebGPU's async calls, -fexceptions for spirv-cross (GL
        -- fallback). No assets - the sphere mesh + instance grid are generated at startup.
        set_extension(".html")
