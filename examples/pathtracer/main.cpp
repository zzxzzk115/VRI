...
#include "shaders/examples/rt_pathtrace_software_spv.h"  // g_rtPathtraceSoftwareSpv (compute BVH fallback, GL/VK)
#include "shaders/examples/rt_pathtrace_software_wgsl.h" // g_rtPathtraceSoftwareWgsl (compute BVH fallback, WebGPU)
#include "shaders/examples/rt_pathtrace_spv.h"           // g_rtPathtraceSpv (Metal/VK inline ray-query megakernel)
#include "shaders/examples/show_tex_dxbc.h"
#include "shaders/examples/show_tex_spv.h"
#include "shaders/examples/show_tex_wgsl.h" // g_showTexWgsl (WebGPU display)
#if defined(_WIN32)
#include "shaders/examples/rt_pathtrace_dxil.h"          // g_rtPathtraceDxilCS (D3D12 inline)
#include "shaders/examples/rt_pathtrace_software_dxil.h" // g_rtPathtraceSoftwareDxilCS (D3D12 compute BVH)
#endif
